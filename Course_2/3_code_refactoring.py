...
def vec(x, y):
    """возвращает пару координат, определ€ющих вектор (координаты точки конца вектора),
...
def draw_points(points, style="points", width=3, color=(255, 255, 255)):
    """функци€ отрисовки точек на экране"""
    if style == "line":
...
def draw_help():
    """функци€ отрисовки экрана справки программы"""
...
# =======================================================================================
# ‘ункции, отвечающие за расчет сглаживани€ ломаной
# =======================================================================================
...
def set_points(points, speeds):
    """функци€ перерасчета координат опорных точек"""
